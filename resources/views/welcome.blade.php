        ...
        <div>
            <div class="container-fluid m-0 d-flex p-2">
                ...
                <div style="width: 50px;height: 50px;">
                    <img src="https://cdn4.iconfinder.com/data/icons/avatars-xmas-giveaway/128/batman_hero_avatar_comics-512.png" width="100%" height="100%" style="border-radius: 50px;">
                </div>
